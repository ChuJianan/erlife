 ...
 */
public class GridViewMainRightAdapter extends BaseAdapter {

    private Context mContext;
    private List<Map<String, Object>> data_list=new ArrayList<Map<String,Object>>();
    private int[] icon = {R.mipmap.ic_gas, R.mipmap.ic_discount,
            R.mipmap.ic_redeem, R.mipmap.ic_tools,};
    private String[] iconName = { "加油省钱", "特权优惠", "兑换礼品", "实用工具"};
    private LayoutInflater mContainer;  //视图容器
    public GridViewMainRightAdapter(Context context){
        mContext=context;
        getData();
...
//        public LinearLayout right_grid_item;
...
//        convertView.setBackgroundResource(icon[position]);
