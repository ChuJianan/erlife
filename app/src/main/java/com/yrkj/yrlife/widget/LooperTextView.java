...
/**
 * Created by cjn on 2016/11/15.
 */

public class LooperTextView extends FrameLayout {
    private List<HomePage.SystemMessageSectionBean> tipList;
    ...
    private void initTipFrame() {
        head_boy = loadDrawable(R.mipmap.icon_laba);
        head_girl = loadDrawable(R.mipmap.icon_laba);
    ...
    private TextView newTextView() {
        ...
        LayoutParams lp = new LayoutParams(
                LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, Gravity.CENTER_VERTICAL);
    ...
    private String getNextTip() {
        ...
        if (!isTime) {
            return tipList.get(curTipIndex++ % tipList.size()).getMessageTitle();
        } else {
            return tipList.get(curTipIndex++ % tipList.size()).getMessageTimeStr();
        }
    }
    ...
    public void setTipList(List<HomePage.SystemMessageSectionBean> tipList, boolean isTime) {
