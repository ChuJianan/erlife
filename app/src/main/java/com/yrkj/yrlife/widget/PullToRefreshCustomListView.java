...
/**
 * 下拉刷新控件
 * Created by cjn on 2016/5/16.
 */
public class PullToRefreshCustomListView extends ListView implements OnScrollListener {
    ...
    public PullToRefreshCustomListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PullToRefreshCustomListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case DONE:
                ...
                arrowImageView.clearAnimation();
                // 此处更换图标
                arrowImageView.setImageResource(R.mipmap.pulltorefresh_arrow);
