...
public class UpdateDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder setCode(int code) {
            this.code = (String) context.getText(code);
            return this;
        }
        ...
        public Builder setSize(int size) {
            this.size = (String) context.getText(size);
            return this;
        }
        ...
        public Builder setDate(int date) {
            this.date = (String) context.getText(date);
            return this;
        }
        ...
        public UpdateDialog create() {
            ...
            ((TextView) layout.findViewById(R.id.titles)).setText(title);
            ((TextView) layout.findViewById(R.id.message)).setText(message);
            ((TextView) layout.findViewById(R.id.date)).setText(date);
            ((TextView) layout.findViewById(R.id.package_size)).setText(size);
            ((TextView) layout.findViewById(R.id.code)).setText(code);
