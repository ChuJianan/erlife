...
public class NearsBrowserActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        machine_number=getIntent().getStringExtra("number");
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.startsWith("tel:")){
                    ...
                    if (ActivityCompat.checkSelfPermission(NearsBrowserActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void refreshEvent(View view){
        ...
        intent.putExtra("result",machine_number);
        startActivity(intent);
        }
    }
}
