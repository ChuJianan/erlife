 ...
 */
@ContentView(R.layout.fragment_unusedquan)
public class FragmentUnusedQuan extends BaseFragment {
...
//        loadData();
    ...
    private void init() {
        mVoucherAdapter = new ListViewVoucherAdapter(getContext(), ldata, 1);
