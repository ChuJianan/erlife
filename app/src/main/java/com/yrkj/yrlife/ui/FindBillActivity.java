...
import com.yrkj.yrlife.adapter.ListViewBillAdapter;
...
public class FindBillActivity extends BaseActivity {

    private ListViewBillAdapter mConsumerAdapter;
    private List<Bill> mConsumerData = new ArrayList<Bill>();
    ...
    private void initView() {
        ...
        mConsumerAdapter = new ListViewBillAdapter(this, mConsumerData);
