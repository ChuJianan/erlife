package com.yrkj.yrlife.ui.addressoption;
...
import com.yrkj.yrlife.been.City;
import com.yrkj.yrlife.db.DBHelper;
import com.yrkj.yrlife.db.DatabaseHelper;
import com.yrkj.yrlife.ui.BaseActivity;
import com.yrkj.yrlife.ui.addressoption.MyLetterListView.OnTouchingLetterChangedListener;
import com.yrkj.yrlife.utils.PingYinUtil;
import com.yrkj.yrlife.utils.UIHelper;

import org.xutils.view.annotation.Event;
import org.xutils.x;

public class AddressActivity extends BaseActivity implements OnScrollListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 3) {
                    UIHelper.city = allCity_lists.get(position).getName();
                    finish();
        ...
        resultList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                UIHelper.city = city_result.get(position).getName();
                finish();
                Toast.makeText(getApplicationContext(),
            ...
            if (viewType == 0) { // 定位
                ...
                city.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        UIHelper.city = city.getText().toString();
                        finish();
                        Toast.makeText(getApplicationContext(),
                ...
                if (UIHelper.location == null) {
                    ...
                    city.setText(UIHelper.location.getCity());
                }
            } else if (viewType == 1) {
                ...
                hotCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        UIHelper.city = city_hot.get(position).getName();
                        finish();
                        Toast.makeText(getApplicationContext(),
